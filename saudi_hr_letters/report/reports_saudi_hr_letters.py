...
import time
from odoo.addons.saudi_hr_letters.report import calverter
...
class BankloanTransfer(models.AbstractModel):
    _name = 'report.saudi_hr_letters.bankloan_transfer_qweb'
    _description = 'Bankloan Transfer Report'
...
class BankloanTransferFemale(models.AbstractModel):
    _name = 'report.saudi_hr_letters.bankloan_transfer_female_qweb'
    _description = 'Bankloan Transfer Female Report'
...
class BankopenAcoount(models.AbstractModel):
    _name = 'report.saudi_hr_letters.bankopen_account_report'
    _description = 'Bankopen Account Report'
    ...
    def render_html(self, docids, data=None):
        ...
        report_obj = Report._get_report_from_name('saudi_hr_letters.bankopen_account_report')
        ...
        return Report.render('saudi_hr_letters.bankopen_account_report', docargs)
...
class BankopenAccountFemale(models.AbstractModel):
    _name = 'report.saudi_hr_letters.bankopen_account_report_female'
    _description = 'Bankopen Account Female Report'
...
class CertiApproval(models.AbstractModel):
    _name = 'report.saudi_hr_letters.certificate_toapprove'
    _description = 'Certifcate ToApprove'
...
class FamilyIqama(models.AbstractModel):
    _name = 'report.saudi_hr_letters.family_iqama_report'
    _description = 'Family Iqama Report'
...
class MroorReport(models.AbstractModel):
    _name = 'report.saudi_hr_letters.mroor_qreport'
    _description = 'Mroor Report'
...
class HouseAllowance(models.AbstractModel):
    _name = 'report.saudi_hr_letters.house_allowance_report'
    _description = 'House Allowance Report'
...
class WhomeConcern(models.AbstractModel):
    _name = 'report.saudi_hr_letters.whomeconcern_report'
    _description = 'WhomeConcern Report'
...
class TowhomeConcern(models.AbstractModel):
    _name = 'report.saudi_hr_letters.towhome_concern_arabic_report'
    _description = 'TowhomeConcern Arabic Report'
...
class TowhomConcernFemale(models.AbstractModel):
    _name = 'report.saudi_hr_letters.towhom_concern_female_report'
    _description = 'TowhomeConcern Female Report'
...
class StampingCertificate(models.AbstractModel):
    _name = 'report.saudi_hr_letters.stamping_certificate_report'
    _description = 'Stamping Certificate Report'
...
class StampingCertificateFemale(models.AbstractModel):
    _name = 'report.saudi_hr_letters.stamping_certificate_female_report'
    _description = 'Stamping Certificate Female Report'
...
class WifefromHomeCountry(models.AbstractModel):
    _name = 'report.saudi_hr_letters.wifefrom_home_country_report'
    _description = 'Wife from Home Country Report'
...
class WalidSchool(models.AbstractModel):
    _name = 'report.saudi_hr_letters.walid_school_report'
    _description = 'Walid School Report'
...
class SaudibritishBankloan(models.AbstractModel):
    _name = 'report.saudi_hr_letters.saudibritish_bankloan_report'
    _description = 'Saudibritish Bankloan Report'
...
class Transport(models.AbstractModel):
    _name = 'report.saudi_hr_letters.saudi_hr_letters_transport_report'
    _description = 'Saudi HR Letters Transport Report'

...
class AdminReports(models.TransientModel):
    ...
    # report = fields.Char(string="Travel", required=False, )
    # supplier_id = fields.Many2one('res.partner', string='Supplier', context="{'search_default_supplier': 1}")
    #
    #
    ...
    #                      'travel_date': datetime.strftime(flight_line.travel_date, DEFAULT_SERVER_DATE_FORMAT) or '',
